...
#ifndef __DistCalc_mul_32s_fYi__HH__
#define __DistCalc_mul_32s_fYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(DistCalc_mul_32s_fYi) {
    ...
    SC_CTOR(DistCalc_mul_32s_fYi):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
