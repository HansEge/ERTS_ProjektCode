...
file delete -force [file join "../tv" DistCalc.hdltvin.dat]
file delete -force [file join "../tv" DistCalc.hdltvout.dat]
...
if {[file isfile DistCalc.hdltvin.dat]} {
	file copy -force DistCalc.hdltvin.dat [file join "../tv" DistCalc.hdltvin.dat]
}
if {[file isfile DistCalc.hdltvout.dat]} {
	file copy -force DistCalc.hdltvout.dat [file join "../tv" DistCalc.hdltvout.dat]
}
...
if {![file exists [file join "../tv" DistCalc.hdltvin.dat]]} {
	ap_puts_err "COSIM" 332 "Test Vector DistCalc.hdltvin.dat in /tv dir doesn't exist."
	return -code error -errorcode $::errorCode
}

file copy -force [file join "../tv" DistCalc.hdltvin.dat] DistCalc.hdltvin.dat

file copy -force [file join "../tv" DistCalc.hdltvout.dat] DistCalc.hdltvout.dat
