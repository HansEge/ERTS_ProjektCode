...
add_wave /AUTOTB_TOP/DistCalc_inst/outputDist -into $outputDist_group -radix hex
set cinputgroup [add_wave_group "C Inputs" -into $designtopgroup]
set y_group [add_wave_group y(fifo) -into $cinputgroup]
add_wave /AUTOTB_TOP/DistCalc_inst/y_read -into $y_group -color #ffff00 -radix hex
add_wave /AUTOTB_TOP/DistCalc_inst/y_empty_n -into $y_group -color #ffff00 -radix hex
add_wave /AUTOTB_TOP/DistCalc_inst/y_dout -into $y_group -radix hex
set x_group [add_wave_group x(fifo) -into $cinputgroup]
add_wave /AUTOTB_TOP/DistCalc_inst/x_read -into $x_group -color #ffff00 -radix hex
add_wave /AUTOTB_TOP/DistCalc_inst/x_empty_n -into $x_group -color #ffff00 -radix hex
add_wave /AUTOTB_TOP/DistCalc_inst/x_dout -into $x_group -radix hex
set ready_group [add_wave_group ready(wire) -into $cinputgroup]
add_wave /AUTOTB_TOP/DistCalc_inst/ready -into $ready_group -radix hex
set numberOfPoints_group [add_wave_group numberOfPoints(wire) -into $cinputgroup]
add_wave /AUTOTB_TOP/DistCalc_inst/numberOfPoints -into $numberOfPoints_group -radix hex
set resetgroup [add_wave_group "Reset" -into $designtopgroup]
add_wave /AUTOTB_TOP/DistCalc_inst/reset -into $resetgroup
set clockgroup [add_wave_group "Clock" -into $designtopgroup]
add_wave /AUTOTB_TOP/DistCalc_inst/clk -into $clockgroup
