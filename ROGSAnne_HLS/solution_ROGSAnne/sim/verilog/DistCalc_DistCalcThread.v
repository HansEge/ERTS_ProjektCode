...
wire   [0:0] tmp_read_fu_80_p2;
wire    ap_CS_fsm_state3;
reg   [0:0] tmp_reg_205;
wire   [0:0] tmp_4_fu_170_p2;
reg    y2_blk_n;
reg    ap_block_state2;
reg   [31:0] tmp_15_reg_209;
reg   [31:0] tmp_18_reg_227;
reg    ap_predicate_op112_read_state3;
reg    ap_block_state3;
reg   [31:0] tmp_19_reg_232;
wire  signed [31:0] tmp_7_fu_175_p2;
reg  signed [31:0] tmp_7_reg_237;
wire  signed [31:0] tmp_9_fu_181_p2;
reg  signed [31:0] tmp_9_reg_243;
wire   [31:0] i_1_fu_187_p2;
reg   [31:0] i_1_reg_249;
wire   [31:0] grp_fu_193_p2;
reg   [31:0] tmp_8_reg_254;
wire    ap_CS_fsm_state5;
wire   [31:0] grp_fu_197_p2;
reg   [31:0] tmp_s_reg_259;
wire   [31:0] tmp_1_fu_201_p2;
reg   [31:0] tmp_1_reg_264;
wire    ap_CS_fsm_state6;
wire   [63:0] grp_fu_162_p1;
reg   [63:0] tmp_2_reg_269;
wire    ap_CS_fsm_state12;
wire   [63:0] grp_fu_165_p2;
reg   [63:0] tmp_3_reg_274;
wire    ap_CS_fsm_state69;
wire   [63:0] grp_fu_157_p2;
wire    ap_CS_fsm_state77;
reg   [63:0] totalDist_reg_111;
reg   [31:0] x_reg_123;
reg   [31:0] y_reg_132;
reg   [31:0] i_reg_141;
wire   [31:0] v_fu_152_p1;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state77)) begin
        i_reg_141 <= i_1_reg_249;
    end else if (((1'b1 == ap_CS_fsm_state2) & (tmp_read_fu_80_p2 == 1'd1) & ~(((tmp_read_fu_80_p2 == 1'd1) & (1'b0 == x1_empty_n)) | ((tmp_read_fu_80_p2 == 1'd1) & (1'b0 == y2_empty_n))))) begin
        i_reg_141 <= 32'd1;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state77)) begin
        totalDist_reg_111 <= grp_fu_157_p2;
    end else if (((1'b1 == ap_CS_fsm_state2) & (tmp_read_fu_80_p2 == 1'd1) & ~(((tmp_read_fu_80_p2 == 1'd1) & (1'b0 == x1_empty_n)) | ((tmp_read_fu_80_p2 == 1'd1) & (1'b0 == y2_empty_n))))) begin
        totalDist_reg_111 <= 64'd0;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state77)) begin
        x_reg_123 <= tmp_18_reg_227;
    end else if (((1'b1 == ap_CS_fsm_state2) & (tmp_read_fu_80_p2 == 1'd1) & ~(((tmp_read_fu_80_p2 == 1'd1) & (1'b0 == x1_empty_n)) | ((tmp_read_fu_80_p2 == 1'd1) & (1'b0 == y2_empty_n))))) begin
        x_reg_123 <= x1_dout;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state3) & (1'b1 == ap_predicate_op112_read_state3) & ~(((1'b0 == x1_empty_n) & (1'b1 == ap_predicate_op112_read_state3)) | ((1'b0 == y2_empty_n) & (1'b1 == ap_predicate_op112_read_state3))))) begin
        i_1_reg_249 <= i_1_fu_187_p2;
        tmp_18_reg_227 <= x1_dout;
        tmp_19_reg_232 <= y2_dout;
        tmp_7_reg_237 <= tmp_7_fu_175_p2;
        tmp_9_reg_243 <= tmp_9_fu_181_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (tmp_read_fu_80_p2 == 1'd1) & ~(((tmp_read_fu_80_p2 == 1'd1) & (1'b0 == x1_empty_n)) | ((tmp_read_fu_80_p2 == 1'd1) & (1'b0 == y2_empty_n))))) begin
        tmp_15_reg_209 <= numberOfPoints;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        tmp_1_reg_264 <= tmp_1_fu_201_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state12)) begin
        tmp_2_reg_269 <= grp_fu_162_p1;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state69)) begin
        tmp_3_reg_274 <= grp_fu_165_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        tmp_8_reg_254 <= grp_fu_193_p2;
        tmp_s_reg_259 <= grp_fu_197_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & ~(((tmp_read_fu_80_p2 == 1'd1) & (1'b0 == x1_empty_n)) | ((tmp_read_fu_80_p2 == 1'd1) & (1'b0 == y2_empty_n))))) begin
        tmp_reg_205 <= ready;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state3) & (1'd1 == tmp_reg_205) & ~(((1'b0 == x1_empty_n) & (1'b1 == ap_predicate_op112_read_state3)) | ((1'b0 == y2_empty_n) & (1'b1 == ap_predicate_op112_read_state3))) & (tmp_4_fu_170_p2 == 1'd0))) begin
...
always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_state2) & (tmp_read_fu_80_p2 == 1'd1)) | ((1'b1 == ap_CS_fsm_state3) & (1'd1 == tmp_reg_205) & (1'd1 == tmp_4_fu_170_p2)))) begin
        x1_blk_n = x1_empty_n;
    end else begin
        x1_blk_n = 1'b1;
    end
...
always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_state2) & (tmp_read_fu_80_p2 == 1'd1) & ~(((tmp_read_fu_80_p2 == 1'd1) & (1'b0 == x1_empty_n)) | ((tmp_read_fu_80_p2 == 1'd1) & (1'b0 == y2_empty_n)))) | ((1'b1 == ap_CS_fsm_state3) & (1'b1 == ap_predicate_op112_read_state3) & ~(((1'b0 == x1_empty_n) & (1'b1 == ap_predicate_op112_read_state3)) | ((1'b0 == y2_empty_n) & (1'b1 == ap_predicate_op112_read_state3)))))) begin
        x1_read = 1'b1;
    end else begin
        x1_read = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((1'b1 == ap_CS_fsm_state3) & ~(((1'b0 == x1_empty_n) & (1'b1 == ap_predicate_op112_read_state3)) | ((1'b0 == y2_empty_n) & (1'b1 == ap_predicate_op112_read_state3))) & ((tmp_4_fu_170_p2 == 1'd0) | (tmp_reg_205 == 1'd0)))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else if (((1'b1 == ap_CS_fsm_state3) & (1'd1 == tmp_reg_205) & (1'd1 == tmp_4_fu_170_p2) & ~(((1'b0 == x1_empty_n) & (1'b1 == ap_predicate_op112_read_state3)) | ((1'b0 == y2_empty_n) & (1'b1 == ap_predicate_op112_read_state3))))) begin
...
always @ (*) begin
    ap_block_state2 = (((tmp_read_fu_80_p2 == 1'd1) & (1'b0 == x1_empty_n)) | ((tmp_read_fu_80_p2 == 1'd1) & (1'b0 == y2_empty_n)));
end

always @ (*) begin
    ap_block_state3 = (((1'b0 == x1_empty_n) & (1'b1 == ap_predicate_op112_read_state3)) | ((1'b0 == y2_empty_n) & (1'b1 == ap_predicate_op112_read_state3)));
end

always @ (*) begin
    ap_predicate_op112_read_state3 = ((1'd1 == tmp_reg_205) & (1'd1 == tmp_4_fu_170_p2));
end

assign i_1_fu_187_p2 = (i_reg_141 + 32'd1);

assign outputDist = v_fu_152_p1;

assign tmp_1_fu_201_p2 = (tmp_s_reg_259 + tmp_8_reg_254);

assign tmp_4_fu_170_p2 = ((i_reg_141 < tmp_15_reg_209) ? 1'b1 : 1'b0);

assign tmp_7_fu_175_p2 = (x1_dout - x_reg_123);

assign tmp_9_fu_181_p2 = (y2_dout - y_reg_132);

assign tmp_read_fu_80_p2 = ready;
