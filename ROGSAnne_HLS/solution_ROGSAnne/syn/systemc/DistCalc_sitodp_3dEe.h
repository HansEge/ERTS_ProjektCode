...
#ifndef __DistCalc_sitodp_3dEe__HH__
#define __DistCalc_sitodp_3dEe__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(DistCalc_sitodp_3dEe) {
    ...
    SC_CTOR(DistCalc_sitodp_3dEe):  ACMP_sitodp_U ("ACMP_sitodp_U") {
