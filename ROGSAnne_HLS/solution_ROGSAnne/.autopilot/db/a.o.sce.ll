...
define void @"DistCalc::DistCalcThread"(i1* %clk, i1* %reset, i1* %busy, i32* %numberOfPoints, i1* %ready, i32* %x, i32* %y, float* %outputDist) {
  ...
  call void @llvm.dbg.value(metadata !{i1* %clk}, i64 0, metadata !87), !dbg !599
  call void @llvm.dbg.value(metadata !{i1* %reset}, i64 0, metadata !600), !dbg !599
  call void @llvm.dbg.value(metadata !{i1* %busy}, i64 0, metadata !601), !dbg !599
  call void @llvm.dbg.value(metadata !{i32* %numberOfPoints}, i64 0, metadata !612), !dbg !599
  call void @llvm.dbg.value(metadata !{i1* %ready}, i64 0, metadata !622), !dbg !599
  call void @llvm.dbg.value(metadata !{i32* %x}, i64 0, metadata !623), !dbg !599
  call void @llvm.dbg.value(metadata !{i32* %y}, i64 0, metadata !633), !dbg !599
  call void @llvm.dbg.value(metadata !{float* %outputDist}, i64 0, metadata !634), !dbg !599
  call void (...)* @_ssdm_op_SpecPort([9 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [4 x i8]* @p_str2, i32 0, i32 0, i1* %clk) nounwind, !dbg !648
  call void (...)* @_ssdm_op_SpecPort([9 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [6 x i8]* @p_str3, i32 0, i32 0, i1* %reset) nounwind, !dbg !650
  call void (...)* @_ssdm_op_SpecPort([9 x i8]* @p_str, i32 1, [7 x i8]* @p_str1, [5 x i8]* @p_str4, i32 0, i32 0, i1* %busy) nounwind, !dbg !651
  call void (...)* @_ssdm_op_SpecPort([9 x i8]* @p_str, i32 0, [6 x i8]* @p_str5, [15 x i8]* @p_str6, i32 0, i32 0, i32* %numberOfPoints) nounwind, !dbg !652
  call void (...)* @_ssdm_op_SpecPort([9 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [6 x i8]* @p_str7, i32 0, i32 0, i1* %ready) nounwind, !dbg !653
  call void (...)* @_ssdm_op_SpecInterface(i32* %x, [8 x i8]* @p_str8, i32 0, i32 0, [1 x i8]* @p_str9, i32 0, i32 0, [1 x i8]* @p_str9, [1 x i8]* @p_str9, [1 x i8]* @p_str9, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str9, [1 x i8]* @p_str9) nounwind, !dbg !654
  call void (...)* @_ssdm_op_SpecInterface(i32* %y, [8 x i8]* @p_str8, i32 0, i32 0, [1 x i8]* @p_str9, i32 0, i32 0, [1 x i8]* @p_str9, [1 x i8]* @p_str9, [1 x i8]* @p_str9, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str9, [1 x i8]* @p_str9) nounwind, !dbg !655
  call void (...)* @_ssdm_op_SpecPort([9 x i8]* @p_str, i32 1, [8 x i8]* @p_str10, [11 x i8]* @p_str11, i32 0, i32 0, float* %outputDist) nounwind, !dbg !656
  call void (...)* @_ssdm_op_SpecProcessDef([9 x i8]* @p_str, i32 2, [15 x i8]* @p_str12) nounwind, !dbg !657
  %tmp_1 = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @p_str13), !dbg !658
  call void (...)* @_ssdm_op_SpecProtocol(i32 1, [1 x i8]* @p_str9) nounwind, !dbg !659
  %p_ssdm_reset_v = call i32 (...)* @_ssdm_op_SpecStateBegin(i32 0, i32 0, i32 1) nounwind, !dbg !660
  call void @llvm.dbg.value(metadata !{i32 %p_ssdm_reset_v}, i64 0, metadata !661), !dbg !660
  call void @llvm.dbg.value(metadata !{i1* %busy}, i64 0, metadata !662), !dbg !669
  call void @_ssdm_op_Write.ap_auto.volatile.i1P(i1* %busy, i1 false), !dbg !681
  %empty = call i32 (...)* @_ssdm_op_SpecStateEnd(i32 %p_ssdm_reset_v) nounwind, !dbg !684
  %empty_7 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @p_str13, i32 %tmp_1), !dbg !685
  br label %1, !dbg !686

; <label>:1                                       ; preds = %_ZN7_ap_sc_7sc_core4waitEi.exit, %0
  %loop_begin = call i32 (...)* @_ssdm_op_SpecLoopBegin() nounwind
  call void @llvm.dbg.value(metadata !{i1* %ready}, i64 0, metadata !687), !dbg !693
  %tmp = call i1 @_ssdm_op_Read.ap_auto.volatile.i1P(i1* %ready), !dbg !702
  call void @llvm.dbg.value(metadata !{i1 %tmp}, i64 0, metadata !704), !dbg !694
  br i1 %tmp, label %_ifconv, label %_ZN7_ap_sc_7sc_core4waitEi.exit, !dbg !700

_ifconv:                                          ; preds = %1
  call void @llvm.dbg.value(metadata !{i1* %busy}, i64 0, metadata !662), !dbg !705
  call void @_ssdm_op_Write.ap_auto.volatile.i1P(i1* %busy, i1 true), !dbg !710
  call void @llvm.dbg.value(metadata !{i32* %numberOfPoints}, i64 0, metadata !711), !dbg !718
  %tmp_15 = call i32 @_ssdm_op_Read.ap_auto.volatile.i32P(i32* %numberOfPoints), !dbg !726
  call void @llvm.dbg.value(metadata !{i32 %tmp_15}, i64 0, metadata !728), !dbg !719
  call void @llvm.dbg.value(metadata !{i32 %tmp_15}, i64 0, metadata !729), !dbg !725
  call void @llvm.dbg.value(metadata !{i32* %x}, i64 0, metadata !711), !dbg !731
  %tmp_16 = call i32 @_ssdm_op_Read.ap_fifo.volatile.i32P(i32* %x), !dbg !739
  call void @llvm.dbg.value(metadata !{i32 %tmp_16}, i64 0, metadata !740), !dbg !732
  call void @llvm.dbg.value(metadata !{i32 %tmp_16}, i64 0, metadata !741), !dbg !738
  call void @llvm.dbg.value(metadata !{i32* %y}, i64 0, metadata !711), !dbg !742
  %tmp_17 = call i32 @_ssdm_op_Read.ap_fifo.volatile.i32P(i32* %y), !dbg !746
  call void @llvm.dbg.value(metadata !{i32 %tmp_17}, i64 0, metadata !740), !dbg !743
  call void @llvm.dbg.value(metadata !{i32 %tmp_17}, i64 0, metadata !747), !dbg !745
  %DistCalc_x_m_if_Val_s = call i32 @_ssdm_op_Read.ap_fifo.volatile.i32P(i32* %x), !dbg !748
  %DistCalc_y_m_if_Val_s = call i32 @_ssdm_op_Read.ap_fifo.volatile.i32P(i32* %y), !dbg !754
  %tmp_11 = call i31 @_ssdm_op_PartSelect.i31.i32.i32.i32(i32 %tmp_15, i32 1, i32 31), !dbg !758
  %icmp = icmp ne i31 %tmp_11, 0, !dbg !758
  %tmp_9 = sub nsw i32 %DistCalc_x_m_if_Val_s, %tmp_16, !dbg !759
  %tmp_s = mul nsw i32 %tmp_9, %tmp_9, !dbg !759
  %tmp_5 = sub nsw i32 %DistCalc_y_m_if_Val_s, %tmp_17, !dbg !759
  %tmp_2 = mul nsw i32 %tmp_5, %tmp_5, !dbg !759
  %tmp_3 = add nsw i32 %tmp_2, %tmp_s, !dbg !759
  %tmp_6 = sitofp i32 %tmp_3 to double, !dbg !759
  %tmp_7 = call double @llvm.sqrt.f64(double %tmp_6), !dbg !759
  %totalDist_1 = select i1 %icmp, double %tmp_7, double 0.000000e+00
  %DistCalc_x_m_if_Val_1 = call i32 @_ssdm_op_Read.ap_fifo.volatile.i32P(i32* %x), !dbg !748
  %DistCalc_y_m_if_Val_1 = call i32 @_ssdm_op_Read.ap_fifo.volatile.i32P(i32* %y), !dbg !754
  %tmp_8_1 = icmp ugt i32 %tmp_15, 2, !dbg !758
  %tmp_9_1 = sub nsw i32 %DistCalc_x_m_if_Val_1, %DistCalc_x_m_if_Val_s, !dbg !759
  %tmp_1_8 = mul nsw i32 %tmp_9_1, %tmp_9_1, !dbg !759
  %tmp_1_1 = sub nsw i32 %DistCalc_y_m_if_Val_1, %DistCalc_y_m_if_Val_s, !dbg !759
  %tmp_2_1 = mul nsw i32 %tmp_1_1, %tmp_1_1, !dbg !759
  %tmp_3_1 = add nsw i32 %tmp_2_1, %tmp_1_8, !dbg !759
  %tmp_6_1 = sitofp i32 %tmp_3_1 to double, !dbg !759
  %tmp_7_1 = call double @llvm.sqrt.f64(double %tmp_6_1), !dbg !759
  %totalDist_2_1 = fadd double %totalDist_1, %tmp_7_1, !dbg !759
  %totalDist_1_1 = select i1 %tmp_8_1, double %totalDist_2_1, double %totalDist_1
  %DistCalc_x_m_if_Val_2 = call i32 @_ssdm_op_Read.ap_fifo.volatile.i32P(i32* %x), !dbg !748
  %DistCalc_y_m_if_Val_2 = call i32 @_ssdm_op_Read.ap_fifo.volatile.i32P(i32* %y), !dbg !754
  %tmp_12 = call i30 @_ssdm_op_PartSelect.i30.i32.i32.i32(i32 %tmp_15, i32 2, i32 31), !dbg !758
  %icmp3 = icmp ne i30 %tmp_12, 0, !dbg !758
  %tmp_9_2 = sub nsw i32 %DistCalc_x_m_if_Val_2, %DistCalc_x_m_if_Val_1, !dbg !759
  %tmp_2_9 = mul nsw i32 %tmp_9_2, %tmp_9_2, !dbg !759
  %tmp_1_2 = sub nsw i32 %DistCalc_y_m_if_Val_2, %DistCalc_y_m_if_Val_1, !dbg !759
  %tmp_2_2 = mul nsw i32 %tmp_1_2, %tmp_1_2, !dbg !759
  %tmp_3_2 = add nsw i32 %tmp_2_2, %tmp_2_9, !dbg !759
  %tmp_6_2 = sitofp i32 %tmp_3_2 to double, !dbg !759
  %tmp_7_2 = call double @llvm.sqrt.f64(double %tmp_6_2), !dbg !759
  %totalDist_2_2 = fadd double %totalDist_1_1, %tmp_7_2, !dbg !759
  %totalDist_1_2 = select i1 %icmp3, double %totalDist_2_2, double %totalDist_1_1
  %DistCalc_x_m_if_Val_3 = call i32 @_ssdm_op_Read.ap_fifo.volatile.i32P(i32* %x), !dbg !748
  %DistCalc_y_m_if_Val_3 = call i32 @_ssdm_op_Read.ap_fifo.volatile.i32P(i32* %y), !dbg !754
  %tmp_8_3 = icmp ugt i32 %tmp_15, 4, !dbg !758
  %tmp_9_3 = sub nsw i32 %DistCalc_x_m_if_Val_3, %DistCalc_x_m_if_Val_2, !dbg !759
  %tmp_3_10 = mul nsw i32 %tmp_9_3, %tmp_9_3, !dbg !759
  %tmp_1_3 = sub nsw i32 %DistCalc_y_m_if_Val_3, %DistCalc_y_m_if_Val_2, !dbg !759
  %tmp_2_3 = mul nsw i32 %tmp_1_3, %tmp_1_3, !dbg !759
  %tmp_3_3 = add nsw i32 %tmp_2_3, %tmp_3_10, !dbg !759
  %tmp_6_3 = sitofp i32 %tmp_3_3 to double, !dbg !759
  %tmp_7_3 = call double @llvm.sqrt.f64(double %tmp_6_3), !dbg !759
  %totalDist_2_3 = fadd double %totalDist_1_2, %tmp_7_3, !dbg !759
  %totalDist_1_3 = select i1 %tmp_8_3, double %totalDist_2_3, double %totalDist_1_2
  %DistCalc_x_m_if_Val_4 = call i32 @_ssdm_op_Read.ap_fifo.volatile.i32P(i32* %x), !dbg !748
  %DistCalc_y_m_if_Val_4 = call i32 @_ssdm_op_Read.ap_fifo.volatile.i32P(i32* %y), !dbg !754
  %tmp_8_4 = icmp ugt i32 %tmp_15, 5, !dbg !758
  %tmp_9_4 = sub nsw i32 %DistCalc_x_m_if_Val_4, %DistCalc_x_m_if_Val_3, !dbg !759
  %tmp_4 = mul nsw i32 %tmp_9_4, %tmp_9_4, !dbg !759
  %tmp_1_4 = sub nsw i32 %DistCalc_y_m_if_Val_4, %DistCalc_y_m_if_Val_3, !dbg !759
  %tmp_2_4 = mul nsw i32 %tmp_1_4, %tmp_1_4, !dbg !759
  %tmp_3_4 = add nsw i32 %tmp_2_4, %tmp_4, !dbg !759
  %tmp_6_4 = sitofp i32 %tmp_3_4 to double, !dbg !759
  %tmp_7_4 = call double @llvm.sqrt.f64(double %tmp_6_4), !dbg !759
  %totalDist_2_4 = fadd double %totalDist_1_3, %tmp_7_4, !dbg !759
  %totalDist_1_4 = select i1 %tmp_8_4, double %totalDist_2_4, double %totalDist_1_3
  %DistCalc_x_m_if_Val_5 = call i32 @_ssdm_op_Read.ap_fifo.volatile.i32P(i32* %x), !dbg !748
  %DistCalc_y_m_if_Val_5 = call i32 @_ssdm_op_Read.ap_fifo.volatile.i32P(i32* %y), !dbg !754
  %tmp_8_5 = icmp ugt i32 %tmp_15, 6, !dbg !758
  %tmp_9_5 = sub nsw i32 %DistCalc_x_m_if_Val_5, %DistCalc_x_m_if_Val_4, !dbg !759
  %tmp_5_11 = mul nsw i32 %tmp_9_5, %tmp_9_5, !dbg !759
  %tmp_1_5 = sub nsw i32 %DistCalc_y_m_if_Val_5, %DistCalc_y_m_if_Val_4, !dbg !759
  %tmp_2_5 = mul nsw i32 %tmp_1_5, %tmp_1_5, !dbg !759
  %tmp_3_5 = add nsw i32 %tmp_2_5, %tmp_5_11, !dbg !759
  %tmp_6_5 = sitofp i32 %tmp_3_5 to double, !dbg !759
  %tmp_7_5 = call double @llvm.sqrt.f64(double %tmp_6_5), !dbg !759
  %totalDist_2_5 = fadd double %totalDist_1_4, %tmp_7_5, !dbg !759
  %totalDist_1_5 = select i1 %tmp_8_5, double %totalDist_2_5, double %totalDist_1_4
  %DistCalc_x_m_if_Val_6 = call i32 @_ssdm_op_Read.ap_fifo.volatile.i32P(i32* %x), !dbg !748
  %DistCalc_y_m_if_Val_6 = call i32 @_ssdm_op_Read.ap_fifo.volatile.i32P(i32* %y), !dbg !754
  %tmp_13 = call i29 @_ssdm_op_PartSelect.i29.i32.i32.i32(i32 %tmp_15, i32 3, i32 31), !dbg !758
  %icmp6 = icmp ne i29 %tmp_13, 0, !dbg !758
  %tmp_9_6 = sub nsw i32 %DistCalc_x_m_if_Val_6, %DistCalc_x_m_if_Val_5, !dbg !759
  %tmp_6_12 = mul nsw i32 %tmp_9_6, %tmp_9_6, !dbg !759
  %tmp_1_6 = sub nsw i32 %DistCalc_y_m_if_Val_6, %DistCalc_y_m_if_Val_5, !dbg !759
  %tmp_2_6 = mul nsw i32 %tmp_1_6, %tmp_1_6, !dbg !759
  %tmp_3_6 = add nsw i32 %tmp_2_6, %tmp_6_12, !dbg !759
  %tmp_6_6 = sitofp i32 %tmp_3_6 to double, !dbg !759
  %tmp_7_6 = call double @llvm.sqrt.f64(double %tmp_6_6), !dbg !759
  %totalDist_2_6 = fadd double %totalDist_1_5, %tmp_7_6, !dbg !759
  %totalDist_1_6 = select i1 %icmp6, double %totalDist_2_6, double %totalDist_1_5
  %DistCalc_x_m_if_Val_7 = call i32 @_ssdm_op_Read.ap_fifo.volatile.i32P(i32* %x), !dbg !748
  %DistCalc_y_m_if_Val_7 = call i32 @_ssdm_op_Read.ap_fifo.volatile.i32P(i32* %y), !dbg !754
  %tmp_8_7 = icmp ugt i32 %tmp_15, 8, !dbg !758
  %tmp_9_7 = sub nsw i32 %DistCalc_x_m_if_Val_7, %DistCalc_x_m_if_Val_6, !dbg !759
  %tmp_7_13 = mul nsw i32 %tmp_9_7, %tmp_9_7, !dbg !759
  %tmp_1_7 = sub nsw i32 %DistCalc_y_m_if_Val_7, %DistCalc_y_m_if_Val_6, !dbg !759
  %tmp_2_7 = mul nsw i32 %tmp_1_7, %tmp_1_7, !dbg !759
  %tmp_3_7 = add nsw i32 %tmp_2_7, %tmp_7_13, !dbg !759
  %tmp_6_7 = sitofp i32 %tmp_3_7 to double, !dbg !759
  %tmp_7_7 = call double @llvm.sqrt.f64(double %tmp_6_7), !dbg !759
  %totalDist_2_7 = fadd double %totalDist_1_6, %tmp_7_7, !dbg !759
  %totalDist_1_7 = select i1 %tmp_8_7, double %totalDist_2_7, double %totalDist_1_6
  %DistCalc_x_m_if_Val_8 = call i32 @_ssdm_op_Read.ap_fifo.volatile.i32P(i32* %x), !dbg !748
  %DistCalc_y_m_if_Val_8 = call i32 @_ssdm_op_Read.ap_fifo.volatile.i32P(i32* %y), !dbg !754
  %tmp_8_8 = icmp ugt i32 %tmp_15, 9, !dbg !758
  %tmp_9_8 = sub nsw i32 %DistCalc_x_m_if_Val_8, %DistCalc_x_m_if_Val_7, !dbg !759
  %tmp_8 = mul nsw i32 %tmp_9_8, %tmp_9_8, !dbg !759
  %tmp_1_8_14 = sub nsw i32 %DistCalc_y_m_if_Val_8, %DistCalc_y_m_if_Val_7, !dbg !759
  %tmp_2_8 = mul nsw i32 %tmp_1_8_14, %tmp_1_8_14, !dbg !759
  %tmp_3_8 = add nsw i32 %tmp_2_8, %tmp_8, !dbg !759
  %tmp_6_8 = sitofp i32 %tmp_3_8 to double, !dbg !759
  %tmp_7_8 = call double @llvm.sqrt.f64(double %tmp_6_8), !dbg !759
  %totalDist_2_8 = fadd double %totalDist_1_7, %tmp_7_8, !dbg !759
  %totalDist_1_8 = select i1 %tmp_8_8, double %totalDist_2_8, double %totalDist_1_7
  %v = fptrunc double %totalDist_1_8 to float, !dbg !760
  call void @llvm.dbg.value(metadata !{float %v}, i64 0, metadata !761), !dbg !768
  call void @llvm.dbg.value(metadata !{float* %outputDist}, i64 0, metadata !772), !dbg !780
  call void @llvm.dbg.value(metadata !{float %v}, i64 0, metadata !782), !dbg !784
  call void @_ssdm_op_Write.ap_auto.volatile.floatP(float* %outputDist, float %v), !dbg !785
  call void @_ssdm_op_Write.ap_auto.volatile.i1P(i1* %busy, i1 false), !dbg !786
  br label %_ZN7_ap_sc_7sc_core4waitEi.exit, !dbg !790

_ZN7_ap_sc_7sc_core4waitEi.exit:                  ; preds = %_ifconv, %1
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !791
  br label %1, !dbg !798
}
...
define weak void @"DistCalc::DistCalc"(i1* %clk, i1* %reset, i1* %busy, i32* %numberOfPoints, i1* %ready, i32* %x, i32* %y, float* %outputDist) {
  ...
  call void (...)* @_ssdm_op_SpecBitsMap(i32* %y), !map !79
  call void (...)* @_ssdm_op_SpecBitsMap(float* %outputDist), !map !83
  call void @llvm.dbg.value(metadata !{i1* %clk}, i64 0, metadata !799), !dbg !802
  call void @llvm.dbg.value(metadata !{i1* %reset}, i64 0, metadata !803), !dbg !802
  call void @llvm.dbg.value(metadata !{i1* %busy}, i64 0, metadata !804), !dbg !802
  call void @llvm.dbg.value(metadata !{i32* %numberOfPoints}, i64 0, metadata !805), !dbg !802
  call void @llvm.dbg.value(metadata !{i1* %ready}, i64 0, metadata !806), !dbg !802
  call void @llvm.dbg.value(metadata !{i32* %x}, i64 0, metadata !807), !dbg !802
  call void @llvm.dbg.value(metadata !{i32* %y}, i64 0, metadata !808), !dbg !802
  call void @llvm.dbg.value(metadata !{float* %outputDist}, i64 0, metadata !809), !dbg !802
  call void @llvm.dbg.value(metadata !{i32* %x}, i64 0, metadata !810), !dbg !816
  call void @llvm.dbg.value(metadata !{i32* %x}, i64 0, metadata !817), !dbg !821
  call void @llvm.dbg.value(metadata !{i32* %x}, i64 0, metadata !822), !dbg !829
  call void @llvm.dbg.value(metadata !{i32* %x}, i64 0, metadata !830), !dbg !834
  call void (...)* @_ssdm_op_SpecInterface(i32* %x, [8 x i8]* @p_str8, i32 0, i32 0, [1 x i8]* @p_str9, i32 0, i32 0, [1 x i8]* @p_str9, [1 x i8]* @p_str9, [1 x i8]* @p_str9, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str9, [1 x i8]* @p_str9) nounwind, !dbg !835
  call void (...)* @_ssdm_op_SpecPort([1 x i8]* @p_str9, i32 4, [1 x i8]* @p_str9, [1 x i8]* @p_str9, i32 0, i32 0, i32* %x) nounwind, !dbg !837
  call void @llvm.dbg.value(metadata !{i32* %y}, i64 0, metadata !810), !dbg !816
  call void @llvm.dbg.value(metadata !{i32* %y}, i64 0, metadata !817), !dbg !821
  call void @llvm.dbg.value(metadata !{i32* %y}, i64 0, metadata !822), !dbg !829
  call void @llvm.dbg.value(metadata !{i32* %y}, i64 0, metadata !830), !dbg !834
  call void (...)* @_ssdm_op_SpecInterface(i32* %y, [8 x i8]* @p_str8, i32 0, i32 0, [1 x i8]* @p_str9, i32 0, i32 0, [1 x i8]* @p_str9, [1 x i8]* @p_str9, [1 x i8]* @p_str9, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str9, [1 x i8]* @p_str9) nounwind, !dbg !835
  call void (...)* @_ssdm_op_SpecPort([1 x i8]* @p_str9, i32 4, [1 x i8]* @p_str9, [1 x i8]* @p_str9, i32 0, i32 0, i32* %y) nounwind, !dbg !837
  call void (...)* @_ssdm_op_SpecTopModule([9 x i8]* @p_str, [9 x i8]* @p_str) nounwind, !dbg !838
  %DistCalc_ssdm_thr = load i1* @DistCalc_ssdm_thread_M_DistCalcThread, align 1, !dbg !840
  br i1 %DistCalc_ssdm_thr, label %1, label %2, !dbg !840

; <label>:1                                       ; preds = %0
  call void @"DistCalc::DistCalcThread"(i1* %clk, i1* %reset, i1* %busy, i32* %numberOfPoints, i1* %ready, i32* %x, i32* %y, float* %outputDist), !dbg !841
  unreachable

; <label>:2                                       ; preds = %0
  call void (...)* @_ssdm_op_SpecProcessDecl([9 x i8]* @p_str, i32 2, [15 x i8]* @p_str12) nounwind, !dbg !842
  call void (...)* @_ssdm_op_SpecSensitive([15 x i8]* @p_str12, [4 x i8]* @p_str2, i1* %clk, i32 1) nounwind, !dbg !843
  call void (...)* @_ssdm_op_SpecSensitive([15 x i8]* @p_str12, [6 x i8]* @p_str3, i1* %reset, i32 4) nounwind, !dbg !844
  call void (...)* @_ssdm_op_SpecPort([9 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [4 x i8]* @p_str2, i32 0, i32 0, i1* %clk) nounwind, !dbg !845
  call void (...)* @_ssdm_op_SpecPort([9 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [6 x i8]* @p_str3, i32 0, i32 0, i1* %reset) nounwind, !dbg !846
  call void (...)* @_ssdm_op_SpecPort([9 x i8]* @p_str, i32 1, [7 x i8]* @p_str1, [5 x i8]* @p_str4, i32 0, i32 0, i1* %busy) nounwind, !dbg !847
  call void (...)* @_ssdm_op_SpecPort([9 x i8]* @p_str, i32 0, [6 x i8]* @p_str5, [15 x i8]* @p_str6, i32 0, i32 0, i32* %numberOfPoints) nounwind, !dbg !848
  call void (...)* @_ssdm_op_SpecPort([9 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [6 x i8]* @p_str7, i32 0, i32 0, i1* %ready) nounwind, !dbg !849
  call void (...)* @_ssdm_op_SpecInterface(i32* %x, [8 x i8]* @p_str8, i32 0, i32 0, [1 x i8]* @p_str9, i32 0, i32 0, [1 x i8]* @p_str9, [1 x i8]* @p_str9, [1 x i8]* @p_str9, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str9, [1 x i8]* @p_str9) nounwind, !dbg !850
  call void (...)* @_ssdm_op_SpecPort([9 x i8]* @p_str, i32 4, [6 x i8]* @p_str5, [2 x i8]* @p_str15, i32 0, i32 0, i32* %x) nounwind, !dbg !851
  call void (...)* @_ssdm_op_SpecInterface(i32* %y, [8 x i8]* @p_str8, i32 0, i32 0, [1 x i8]* @p_str9, i32 0, i32 0, [1 x i8]* @p_str9, [1 x i8]* @p_str9, [1 x i8]* @p_str9, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str9, [1 x i8]* @p_str9) nounwind, !dbg !852
  call void (...)* @_ssdm_op_SpecPort([9 x i8]* @p_str, i32 4, [6 x i8]* @p_str5, [2 x i8]* @p_str16, i32 0, i32 0, i32* %y) nounwind, !dbg !853
  call void (...)* @_ssdm_op_SpecPort([9 x i8]* @p_str, i32 1, [8 x i8]* @p_str10, [11 x i8]* @p_str11, i32 0, i32 0, float* %outputDist) nounwind, !dbg !854
  ret void, !dbg !855
}
