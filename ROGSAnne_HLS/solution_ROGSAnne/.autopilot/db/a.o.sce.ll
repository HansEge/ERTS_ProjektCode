...
define void @"DistCalc::DistCalcThread"(i1* %clk, i1* %reset, i32* %numberOfPoints, i1* %ready, i32* %x1, i32* %y2, float* %outputDist) {
  ...
  call void @llvm.dbg.value(metadata !{i1* %clk}, i64 0, metadata !78), !dbg !506
  call void @llvm.dbg.value(metadata !{i1* %reset}, i64 0, metadata !507), !dbg !506
  call void @llvm.dbg.value(metadata !{i32* %numberOfPoints}, i64 0, metadata !508), !dbg !506
  call void @llvm.dbg.value(metadata !{i1* %ready}, i64 0, metadata !518), !dbg !506
  call void @llvm.dbg.value(metadata !{i32* %x1}, i64 0, metadata !519), !dbg !506
  call void @llvm.dbg.value(metadata !{i32* %y2}, i64 0, metadata !529), !dbg !506
  call void @llvm.dbg.value(metadata !{float* %outputDist}, i64 0, metadata !530), !dbg !506
  call void (...)* @_ssdm_op_SpecPort([9 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [4 x i8]* @p_str2, i32 0, i32 0, i1* %clk) nounwind, !dbg !544
  call void (...)* @_ssdm_op_SpecPort([9 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [6 x i8]* @p_str3, i32 0, i32 0, i1* %reset) nounwind, !dbg !546
  call void (...)* @_ssdm_op_SpecPort([9 x i8]* @p_str, i32 0, [6 x i8]* @p_str4, [15 x i8]* @p_str5, i32 0, i32 0, i32* %numberOfPoints) nounwind, !dbg !547
  call void (...)* @_ssdm_op_SpecPort([9 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [6 x i8]* @p_str6, i32 0, i32 0, i1* %ready) nounwind, !dbg !548
  call void (...)* @_ssdm_op_SpecInterface(i32* %x1, [8 x i8]* @p_str7, i32 0, i32 0, [1 x i8]* @p_str8, i32 0, i32 0, [1 x i8]* @p_str8, [1 x i8]* @p_str8, [1 x i8]* @p_str8, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str8, [1 x i8]* @p_str8) nounwind, !dbg !549
  call void (...)* @_ssdm_op_SpecInterface(i32* %y2, [8 x i8]* @p_str7, i32 0, i32 0, [1 x i8]* @p_str8, i32 0, i32 0, [1 x i8]* @p_str8, [1 x i8]* @p_str8, [1 x i8]* @p_str8, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str8, [1 x i8]* @p_str8) nounwind, !dbg !550
  call void (...)* @_ssdm_op_SpecPort([9 x i8]* @p_str, i32 1, [8 x i8]* @p_str9, [11 x i8]* @p_str10, i32 0, i32 0, float* %outputDist) nounwind, !dbg !551
  call void (...)* @_ssdm_op_SpecProcessDef([9 x i8]* @p_str, i32 2, [15 x i8]* @p_str11) nounwind, !dbg !552
  %tmp_5 = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @p_str12), !dbg !553
  call void (...)* @_ssdm_op_SpecProtocol(i32 1, [1 x i8]* @p_str8) nounwind, !dbg !554
  %p_ssdm_reset_v = call i32 (...)* @_ssdm_op_SpecStateBegin(i32 0, i32 0, i32 1) nounwind, !dbg !555
  call void @llvm.dbg.value(metadata !{i32 %p_ssdm_reset_v}, i64 0, metadata !556), !dbg !555
  call void (...)* @_ssdm_op_SpecIFCore(i32* %numberOfPoints, [1 x i8]* @p_str8, [10 x i8]* @p_str16, [1 x i8]* @p_str8, i32 -1, [1 x i8]* @p_str8, [1 x i8]* @p_str8, [1 x i8]* @p_str8, [1 x i8]* @p_str8, [17 x i8]* @p_str17), !dbg !557
  call void (...)* @_ssdm_op_SpecIFCore(i1* %ready, [1 x i8]* @p_str8, [10 x i8]* @p_str16, [1 x i8]* @p_str8, i32 -1, [1 x i8]* @p_str8, [1 x i8]* @p_str8, [1 x i8]* @p_str8, [1 x i8]* @p_str8, [17 x i8]* @p_str17), !dbg !558
  call void (...)* @_ssdm_op_SpecIFCore(float* %outputDist, [1 x i8]* @p_str8, [10 x i8]* @p_str16, [1 x i8]* @p_str8, i32 -1, [1 x i8]* @p_str8, [1 x i8]* @p_str8, [1 x i8]* @p_str8, [1 x i8]* @p_str8, [17 x i8]* @p_str17), !dbg !559
  %empty = call i32 (...)* @_ssdm_op_SpecStateEnd(i32 %p_ssdm_reset_v) nounwind, !dbg !560
  %empty_2 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @p_str12, i32 %tmp_5), !dbg !561
  br label %1, !dbg !562

; <label>:1                                       ; preds = %_ZN7_ap_sc_7sc_core4waitEi.exit, %0
  %loop_begin = call i32 (...)* @_ssdm_op_SpecLoopBegin() nounwind
  call void @llvm.dbg.value(metadata !{i1* %ready}, i64 0, metadata !563), !dbg !571
  %tmp = call i1 @_ssdm_op_Read.ap_auto.volatile.i1P(i1* %ready), !dbg !580
  call void @llvm.dbg.value(metadata !{i1 %tmp}, i64 0, metadata !582), !dbg !572
  br i1 %tmp, label %2, label %_ZN7_ap_sc_7sc_core4waitEi.exit, !dbg !578

; <label>:2                                       ; preds = %1
  call void @llvm.dbg.value(metadata !{i32* %numberOfPoints}, i64 0, metadata !583), !dbg !590
  %tmp_15 = call i32 @_ssdm_op_Read.ap_auto.volatile.i32P(i32* %numberOfPoints), !dbg !599
  call void @llvm.dbg.value(metadata !{i32 %tmp_15}, i64 0, metadata !601), !dbg !591
  call void @llvm.dbg.value(metadata !{i32 %tmp_15}, i64 0, metadata !602), !dbg !597
  call void @llvm.dbg.value(metadata !{i32* %x1}, i64 0, metadata !583), !dbg !604
  %tmp_16 = call i32 @_ssdm_op_Read.ap_fifo.volatile.i32P(i32* %x1), !dbg !612
  call void @llvm.dbg.value(metadata !{i32 %tmp_16}, i64 0, metadata !613), !dbg !605
  call void @llvm.dbg.value(metadata !{i32 %tmp_16}, i64 0, metadata !614), !dbg !611
  call void @llvm.dbg.value(metadata !{i32* %y2}, i64 0, metadata !583), !dbg !615
  %tmp_17 = call i32 @_ssdm_op_Read.ap_fifo.volatile.i32P(i32* %y2), !dbg !619
  call void @llvm.dbg.value(metadata !{i32 %tmp_17}, i64 0, metadata !613), !dbg !616
  call void @llvm.dbg.value(metadata !{i32 %tmp_17}, i64 0, metadata !620), !dbg !618
  br label %3, !dbg !621
...
; <label>:3                                       ; preds = %4, %2
  ...
  %i = phi i32 [ 1, %2 ], [ %i_1, %4 ]
  %tmp_4 = icmp ult i32 %i, %tmp_15, !dbg !621
  br i1 %tmp_4, label %4, label %5, !dbg !621

; <label>:4                                       ; preds = %3
  call void @llvm.dbg.value(metadata !{i32* %x1}, i64 0, metadata !583), !dbg !623
  %tmp_18 = call i32 @_ssdm_op_Read.ap_fifo.volatile.i32P(i32* %x1), !dbg !628
  call void @llvm.dbg.value(metadata !{i32 %tmp_18}, i64 0, metadata !613), !dbg !624
  call void @llvm.dbg.value(metadata !{i32 %tmp_18}, i64 0, metadata !629), !dbg !626
  call void @llvm.dbg.value(metadata !{i32* %y2}, i64 0, metadata !583), !dbg !630
  %tmp_19 = call i32 @_ssdm_op_Read.ap_fifo.volatile.i32P(i32* %y2), !dbg !634
  call void @llvm.dbg.value(metadata !{i32 %tmp_19}, i64 0, metadata !613), !dbg !631
  call void @llvm.dbg.value(metadata !{i32 %tmp_19}, i64 0, metadata !635), !dbg !633
  %tmp_7 = sub nsw i32 %tmp_18, %x, !dbg !636
  %tmp_8 = mul nsw i32 %tmp_7, %tmp_7, !dbg !636
  %tmp_9 = sub nsw i32 %tmp_19, %y, !dbg !636
  %tmp_s = mul nsw i32 %tmp_9, %tmp_9, !dbg !636
  %tmp_1 = add nsw i32 %tmp_s, %tmp_8, !dbg !636
  %tmp_2 = sitofp i32 %tmp_1 to double, !dbg !636
  %tmp_3 = call double @llvm.sqrt.f64(double %tmp_2), !dbg !636
  %totalDist_1 = fadd double %totalDist, %tmp_3, !dbg !636
  call void @llvm.dbg.value(metadata !{double %totalDist_1}, i64 0, metadata !637), !dbg !636
  call void @llvm.dbg.value(metadata !{i32 %tmp_18}, i64 0, metadata !614), !dbg !639
  call void @llvm.dbg.value(metadata !{i32 %tmp_19}, i64 0, metadata !620), !dbg !640
  %i_1 = add nsw i32 %i, 1, !dbg !641
  call void @llvm.dbg.value(metadata !{i32 %i_1}, i64 0, metadata !642), !dbg !641
  br label %3, !dbg !641

; <label>:5                                       ; preds = %3
  %v = fptrunc double %totalDist to float, !dbg !643
  call void @llvm.dbg.value(metadata !{float %v}, i64 0, metadata !644), !dbg !651
  call void @llvm.dbg.value(metadata !{float* %outputDist}, i64 0, metadata !655), !dbg !663
  call void @llvm.dbg.value(metadata !{float %v}, i64 0, metadata !665), !dbg !667
  call void @_ssdm_op_Write.ap_auto.volatile.floatP(float* %outputDist, float %v), !dbg !668
  br label %_ZN7_ap_sc_7sc_core4waitEi.exit, !dbg !669

_ZN7_ap_sc_7sc_core4waitEi.exit:                  ; preds = %5, %1
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !670
  br label %1, !dbg !677
}
...
define weak void @"DistCalc::DistCalc"(i1* %clk, i1* %reset, i32* %numberOfPoints, i1* %ready, i32* %x, i32* %y, float* %outputDist) {
  ...
  call void (...)* @_ssdm_op_SpecBitsMap(float* %outputDist), !map !74
  call void @llvm.dbg.value(metadata !{i1* %clk}, i64 0, metadata !678), !dbg !681
  call void @llvm.dbg.value(metadata !{i1* %reset}, i64 0, metadata !682), !dbg !681
  call void @llvm.dbg.value(metadata !{i32* %numberOfPoints}, i64 0, metadata !683), !dbg !681
  call void @llvm.dbg.value(metadata !{i1* %ready}, i64 0, metadata !684), !dbg !681
  call void @llvm.dbg.value(metadata !{i32* %x}, i64 0, metadata !685), !dbg !681
  call void @llvm.dbg.value(metadata !{i32* %y}, i64 0, metadata !686), !dbg !681
  call void @llvm.dbg.value(metadata !{float* %outputDist}, i64 0, metadata !687), !dbg !681
  call void @llvm.dbg.value(metadata !{i32* %x}, i64 0, metadata !688), !dbg !694
  call void @llvm.dbg.value(metadata !{i32* %x}, i64 0, metadata !695), !dbg !699
  call void @llvm.dbg.value(metadata !{i32* %x}, i64 0, metadata !700), !dbg !707
  call void @llvm.dbg.value(metadata !{i32* %x}, i64 0, metadata !708), !dbg !712
  call void (...)* @_ssdm_op_SpecInterface(i32* %x, [8 x i8]* @p_str7, i32 0, i32 0, [1 x i8]* @p_str8, i32 0, i32 0, [1 x i8]* @p_str8, [1 x i8]* @p_str8, [1 x i8]* @p_str8, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str8, [1 x i8]* @p_str8) nounwind, !dbg !713
  call void (...)* @_ssdm_op_SpecPort([1 x i8]* @p_str8, i32 4, [1 x i8]* @p_str8, [1 x i8]* @p_str8, i32 0, i32 0, i32* %x) nounwind, !dbg !715
  call void @llvm.dbg.value(metadata !{i32* %y}, i64 0, metadata !688), !dbg !694
  call void @llvm.dbg.value(metadata !{i32* %y}, i64 0, metadata !695), !dbg !699
  call void @llvm.dbg.value(metadata !{i32* %y}, i64 0, metadata !700), !dbg !707
  call void @llvm.dbg.value(metadata !{i32* %y}, i64 0, metadata !708), !dbg !712
  call void (...)* @_ssdm_op_SpecInterface(i32* %y, [8 x i8]* @p_str7, i32 0, i32 0, [1 x i8]* @p_str8, i32 0, i32 0, [1 x i8]* @p_str8, [1 x i8]* @p_str8, [1 x i8]* @p_str8, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str8, [1 x i8]* @p_str8) nounwind, !dbg !713
  call void (...)* @_ssdm_op_SpecPort([1 x i8]* @p_str8, i32 4, [1 x i8]* @p_str8, [1 x i8]* @p_str8, i32 0, i32 0, i32* %y) nounwind, !dbg !715
  call void (...)* @_ssdm_op_SpecTopModule([9 x i8]* @p_str, [9 x i8]* @p_str) nounwind, !dbg !716
  %DistCalc_ssdm_thr = load i1* @DistCalc_ssdm_thread_M_DistCalcThread, align 1, !dbg !718
  br i1 %DistCalc_ssdm_thr, label %1, label %2, !dbg !718

; <label>:1                                       ; preds = %0
  call void @"DistCalc::DistCalcThread"(i1* %clk, i1* %reset, i32* %numberOfPoints, i1* %ready, i32* %x, i32* %y, float* %outputDist), !dbg !719
  unreachable

; <label>:2                                       ; preds = %0
  call void (...)* @_ssdm_op_SpecProcessDecl([9 x i8]* @p_str, i32 2, [15 x i8]* @p_str11) nounwind, !dbg !720
  call void (...)* @_ssdm_op_SpecSensitive([15 x i8]* @p_str11, [4 x i8]* @p_str2, i1* %clk, i32 1) nounwind, !dbg !721
  call void (...)* @_ssdm_op_SpecSensitive([15 x i8]* @p_str11, [6 x i8]* @p_str3, i1* %reset, i32 4) nounwind, !dbg !722
  call void (...)* @_ssdm_op_SpecPort([9 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [4 x i8]* @p_str2, i32 0, i32 0, i1* %clk) nounwind, !dbg !723
  call void (...)* @_ssdm_op_SpecPort([9 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [6 x i8]* @p_str3, i32 0, i32 0, i1* %reset) nounwind, !dbg !724
  call void (...)* @_ssdm_op_SpecPort([9 x i8]* @p_str, i32 0, [6 x i8]* @p_str4, [15 x i8]* @p_str5, i32 0, i32 0, i32* %numberOfPoints) nounwind, !dbg !725
  call void (...)* @_ssdm_op_SpecPort([9 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [6 x i8]* @p_str6, i32 0, i32 0, i1* %ready) nounwind, !dbg !726
  call void (...)* @_ssdm_op_SpecInterface(i32* %x, [8 x i8]* @p_str7, i32 0, i32 0, [1 x i8]* @p_str8, i32 0, i32 0, [1 x i8]* @p_str8, [1 x i8]* @p_str8, [1 x i8]* @p_str8, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str8, [1 x i8]* @p_str8) nounwind, !dbg !727
  call void (...)* @_ssdm_op_SpecPort([9 x i8]* @p_str, i32 4, [6 x i8]* @p_str4, [2 x i8]* @p_str14, i32 0, i32 0, i32* %x) nounwind, !dbg !728
  call void (...)* @_ssdm_op_SpecInterface(i32* %y, [8 x i8]* @p_str7, i32 0, i32 0, [1 x i8]* @p_str8, i32 0, i32 0, [1 x i8]* @p_str8, [1 x i8]* @p_str8, [1 x i8]* @p_str8, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str8, [1 x i8]* @p_str8) nounwind, !dbg !729
  call void (...)* @_ssdm_op_SpecPort([9 x i8]* @p_str, i32 4, [6 x i8]* @p_str4, [2 x i8]* @p_str15, i32 0, i32 0, i32* %y) nounwind, !dbg !730
  call void (...)* @_ssdm_op_SpecPort([9 x i8]* @p_str, i32 1, [8 x i8]* @p_str9, [11 x i8]* @p_str10, i32 0, i32 0, float* %outputDist) nounwind, !dbg !731
  ret void, !dbg !732
}
