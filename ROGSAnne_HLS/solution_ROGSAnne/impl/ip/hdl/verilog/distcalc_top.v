...
wire [32 - 1:0] sig_DistCalc_numberOfPoints;
wire [1 - 1:0] sig_DistCalc_ready;
wire [32 - 1:0] sig_DistCalc_outputDist;

wire sig_DistCalc_reset;



DistCalc DistCalc_U(
    .numberOfPoints(sig_DistCalc_numberOfPoints),
    .ready(sig_DistCalc_ready),
    .outputDist(sig_DistCalc_outputDist),
    .reset(sig_DistCalc_reset),
    .clk(aclk),
    .x_dout(x_dout),
    .x_empty_n(x_empty_n),
    .x_read(x_read),
...
DistCalc_slv0_if_U(
    .ACLK(aclk),
    .ARESETN(aresetn),
    .I_numberOfPoints(sig_DistCalc_numberOfPoints),
    .I_ready(sig_DistCalc_ready),
    .O_outputDist(sig_DistCalc_outputDist),
